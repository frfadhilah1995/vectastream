        ...
        <div className="py-6 space-y-4">
            ...
            >
                {channels.map((channel, idx) => (
                    <motion.div
                        key={idx}
                        className="flex-none w-64 aspect-video relative group rounded-xl overflow-hidden bg-white/5 border border-white/10 cursor-pointer snap-start"
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
                            ...
                            <p className="text-xs text-white/60 truncate">{channel.group || 'Unknown Category'}</p>

                            <div className="mt-2 flex items-center gap-2">
                                <button className="p-2 bg-accent-500 rounded-full text-white hover:bg-accent-600 transition-colors">
