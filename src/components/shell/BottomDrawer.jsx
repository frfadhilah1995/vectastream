...
const BottomDrawer = ({
    ...
    const [isPortrait, setIsPortrait] = useState(isMobilePortrait);

    useEffect(() => {
        const media = window.matchMedia('(max-width: 768px) and (orientation: portrait)');
    ...
    const content = (
        <div className={cn(
            ...
            !isPortrait && 'max-h-[80vh] w-full max-w-5xl bg-app-elevated rounded-2xl border border-glass-border shadow-2xl overflow-hidden'
        )}>
            {/* Header */}
            <div className="px-5 py-4 border-b border-glass-border bg-app-elevated z-10">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="p-2 bg-white/5 hover:bg-white/10 text-text-tertiary hover:text-white rounded-lg transition-all ml-2"
                        >
                            <X size={18} />
                        </button>
                    </div>
            ...
            {/* Channel List */}
            <div className="flex-1 overflow-y-auto p-5 custom-scrollbar bg-app-surface/50">
    ...
    // Mobile Portrait: Use Vaul Drawer
    if (isPortrait) {
        return (
